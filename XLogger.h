 ...
 * @Description: 
 * @Author: diyhome
 * @Date: 2021-09-20 21:57
 * @File: XLogger
*/

#ifndef CADENCELIBQML_XLOGGER_H
#define CADENCELIBQML_XLOGGER_H
#pragma once
#include <iostream>
#include <string>
#include <memory>
...
private:
    ...
    {
        // hardcode log path
        const std::string log_dir = SAVE_PATH; // should create the folder if not exist
